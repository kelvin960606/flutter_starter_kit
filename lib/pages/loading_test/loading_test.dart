...
class LoadingTestView extends StatefulWidget {
  LoadingTestView({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _LoadingTestViewState createState() => _LoadingTestViewState();
}

class _LoadingTestViewState extends State<LoadingTestView> {
  Timer _timer;
  double _progress;
